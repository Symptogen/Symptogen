...
int IndieLib()			
{
	...
	if (!mI->_surfaceManager->add(mSurfaceWarrior, "../../resources/dino.png", IND_ALPHA, IND_32, 255, 0, 255)) return 0; // TODO: This calls setAlpha in IND_Image, which is broken, please fix.

	// Loading sprite of a star
	IND_Surface *mSurfaceStar = IND_Surface::newSurface();
	if (!mI->_surfaceManager->add(mSurfaceStar, "../../resources/dino_Headache.png", IND_ALPHA, IND_32, 0, 255, 0)) return 0;
