...
private:
	Text* m_resumeGameButton; /**< the resume last #Player game #Button */
	Text* m_quitButton; /**< the quit #Button */
	Text* m_manageGamesButton; /**< the #Button for accesing the #ManageGamesMenu */
